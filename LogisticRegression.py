...
# (With some modifications differing from the original for the sake of testing and learning)
...
def updateModelPrediction(*args):
	...
	#print('z:', z)
	#print('z (unflattened):', np.dot( W[-1, :], X_model.T) )
	#print(np.dot( W[-1, :], X_model.T) == z) # z and z.flatten() seem to be identical?
	#print(W.shape, X_model.shape)
	#print('W:', W)
	#print('W[-1, :]:', W[-1, :])
	#print(z)
	y_hat = 1 / (1 + np.exp(-z))
